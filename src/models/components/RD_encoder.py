...
class FeatureLayer(nn.Module):
    ...
    def __init__(self, layer_sizes, input_channel=3):
        ...
        self.conv1 = SpatioTemporalConv(input_channel, 96, (1, 7, 7), stride=(1, 2, 2), padding=(0, 3, 3),
                                        first_conv=True)
        self.conv2 = ResLayer(96, 96, 3, layer_sizes[0])
        self.conv3 = ResLayer(96, 192, 3, layer_sizes[1], downsample=True)
        self.conv4 = ResLayer(192, 384, 3, layer_sizes[2], downsample=True)
        self.conv5 = ResLayer(384, 768, 3, layer_sizes[3], downsample=True)
...
class R2Plus1D(nn.Module):
    ...
    at the end producing a 768-dimensional vector for each element in the batch,
